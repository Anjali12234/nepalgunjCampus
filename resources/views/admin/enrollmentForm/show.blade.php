...
@section('container')
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="title">
                        <h4>CEH Registration Form Details</h4>
                    </div>
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.enrollmentForm.index') }}">CEH Registration Form Messages</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">
                                CEH Registration Form Details
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="pd-20 card-box mb-30">
            <h4 class="text-blue h4 mb-4">CEH Registration Form Information</h4>
            <div class="row">
                <div class="col-md-12">
